package guillermo.chavez.practica_guillermo_chavez
...
class fragment_contactanos : Fragment() {
    ...
    override fun onCreateView(
        ...
        val Contacto = root.findViewById<Button>(R.id.btnContacto)
        Contacto.setOnClickListener {
            Toast.makeText(requireContext(), "Mi codigo => 20230075", Toast.LENGTH_LONG).show()
        }
    return root
    }
        companion
